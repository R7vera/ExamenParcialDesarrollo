...
function save(bandera) {
    ...
    const registro = {
        ...
        miDatoDecimal: parseFloat($("#costo").val()),
        ...
        .done((data) => {
            ...
            if (data.ok) {
                $.each(data.body, (index, registro) => {
                    ...
                    t.row.add([botonera, registro.id, registro.nombre, registro.descripcion, registro.miDatoDecimal, registro.fechaInicio, registro.fechaFin]);
                });
                t.draw(false);
            } else {
    ...
    ajaxRequest("GET", `${url}/${id}`)
        .done((data) => {
            if (data.ok) {
                ...
                $("#costo").val(data.body.miDatoDecimal);
